...
Plot::StyleCurveDiag::StyleCurveDiag(const std::string &id, Plot::CurveConfig &live_config,
                                     QWidget *parent)
    : QDialog(parent)
    ...
    QObject::connect(ui->checkBox_antialiasing, &QCheckBox::toggled, this,
                     &StyleCurveDiag::on_ui_changed);

    QObject::connect(ui->spinBox_z_order, &QSpinBox::valueChanged, this,
                     &StyleCurveDiag::on_ui_changed);

    QObject::connect(ui->pushButton_save, &QPushButton::clicked, this,
                     &StyleCurveDiag::on_save_clicked);

    QObject::connect(ui->pushButton_revert, &QPushButton::clicked, this,
                     &StyleCurveDiag::on_cancel_clicked);

    QObject::connect(ui->comboBox_line_style, &QComboBox::activated, this,
                     &StyleCurveDiag::on_ui_changed);

    QObject::connect(ui->comboBox_curve_style, &QComboBox::activated, this,
                     &StyleCurveDiag::on_ui_changed);

    QObject::connect(ui->comboBox_symbol, &QComboBox::activated, this,
                     &StyleCurveDiag::on_ui_changed);

    QObject::connect(ui->doubleSpinBox_y_offset, &QDoubleSpinBox::valueChanged, this,
                     &StyleCurveDiag::on_ui_changed);
...
void Plot::StyleCurveDiag::on_ui_changed() {
    ...
    m_live_config.curve_style =
        static_cast<QwtPlotCurve::CurveStyle>(ui->comboBox_curve_style->currentIndex() - 1);
    m_live_config.symbol_type =
        static_cast<QwtSymbol::Style>(ui->comboBox_symbol->currentIndex() - 1);
