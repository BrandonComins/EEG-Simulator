...
class PacketParser : public QObject
{
  ...
  Q_SIGNALS:
    /*!
     * \brief got_channel_data Emitted when the UI receives channel data
    ...
    /*!
     * \brief got_new_channel Emitted when a new channel id arrives from the hardware
     * \param channel_id The name of the channel
    ...
    /*!
     * \brief got_channel_constants Emitted when a channel constants arrives from the hardware
     * \param constants The simulated channel contants
     */
    void got_channel_constants(Communication::ChannelConstants constants);
